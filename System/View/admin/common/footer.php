    ...
    <div class="row">
        ...
        <div class="col-sm-7 text-right">
            <p>Copyright &copy; 2022
                <?=WEB_TITLE?> All rights reserved.</p>
...
<div class="modal" tabindex="-1" id="DownDevModel">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <select class="form-control selectDom">
      ...
      <div class="modal-footer border-top">
        ...
        <button type="button" class="btn btn-primary" id="DevInstallBtn">安装</button>
      </div>
    </div>
  </div>
</div>