...
class Front extends ControllersAdmin {
    ...
    public function add_Action(){
        if(!empty($_POST)){
            ...
            $this->Jump(array('admin', 'front', 'index'), 1888);
        }
    ...
    public function builder_Action(){
        ...
        $this->LoadView('admin/front/builder', $tmp);
    }
    ...
    public function test_Action(){
        ...
        $this->LoadView('admin/front/test');
    }
    ...
    public function api_Action(){ // 接口演示
        ...
        $tmp['ApiArr'] = $ApiArr;
        $this->LoadView('admin/front/api', $tmp);
    }
